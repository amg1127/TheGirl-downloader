...
pega_endereco () {
    endereco_1="http://www.terra.com.br/thegirl/<MES><ANO><GAROTA>/img/poster<FOTO>.jpg"
    endereco_2="http://img.terra.com.br/thegirl/<MES><ANO><GAROTA>/img/poster<FOTO>.jpg"
    endereco_3="http://img.terra.com.br/thegirl/<MES><ANO><GAROTA>/img/poster<FOTO>g.jpg"
    endereco=""
    [ "$5" == "1" ] && endereco="$endereco_1"
    [ "$5" == "2" ] && endereco="$endereco_2"
    [ "$5" == "3" ] && endereco="$endereco_3"
    if [ "$5" == "4" ]; then
        # http://www.terra.com.br/thegirl/1308/img/poster1-renata-bonjesus.jpg
        endereco="http://www.terra.com.br/thegirl/<MES><ANO><GAROTA>/img/poster<FOTO>-`descobre_nome_garota \"$1\" \"$2\" \"$3\"`.jpg"
    fi
    [ "$endereco" ] || return 1
...
pega_nome_arquivo () {
    ...
    arquivo="ano20${ano}_mes${mes}_gar${3}_poster_${foto}.jpg"
    fname="${pasta}/${arquivo}"
    echo -n "$fname"
...
echo "Pronto para capturar os posters da garota $garota do mes $mes/$ano."
